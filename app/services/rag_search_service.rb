class RagSearchService
  ...
  def ask_sync(question)
    query_result = RubyLLM.embed(question, model: "text-embedding-3-small", assume_model_exists: true)
    ...
    llm_chat = RubyLLM.chat(model: "gpt-4.1-mini", assume_model_exists: true)
